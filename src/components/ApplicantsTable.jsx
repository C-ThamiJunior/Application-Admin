...
const ApplicantsTable = () => {
  ...
  useEffect(() => {
    const fetchApplicants = async () => {
      ...
      try {
        const res = await fetch('https://b-t-backend-uc9w.onrender.com/api/post/all-applications', {
          headers: {
              ...
              {filteredApplicants.length > 0 ? (
                filteredApplicants.map((app, i) => (
                  <tr key={app.id || i}>
                    ...
                    <a
                      href={`https://b-t-backend-uc9w.onrender.com/files/${encodeURIComponent(app.fileNames[0])}`}
